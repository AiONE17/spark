...
columns_to_ch = ("office_id", "wh_id", "place_cod", "entry")
...
schema = StructType([
    ...
    StructField("place_cod", BooleanType(), True),
...
sql_insert = f"""insert into {ch_db_name}.{ch_dst_table}
    ...
    left any join
    (
        select place_type_id, place_type_name
        from default.dict_StoragePlaceType
    ) vols
    on t1.place_cod = vols.place_cod
"""
